...
Pro, which I used to solve real-world problems for business use cases where
there were no off-the-shelf solutions.

My first website required a custom shopping cart that charged delivery fees
based on zip code. I learned PHP and built it from scratch, with mySQL powering
the e-commerce and an admin backend for managing products, using sessions and
encryption. My hybrid career as a web designer and developer was off and
running.
...
always seen it as a platform capable of almost anything, and that has not
changed.
...
It was at Cengage that I began my journey with React. We pursued an ambitious
