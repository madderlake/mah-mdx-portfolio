...
design and recurring site outages.

I moved the site to my hosting platform, deactivated the problematic plugins,
and implemented a new theme. Recovering original assets from the previous
designer, I refreshed the branding, restoring the original colors and identity.
